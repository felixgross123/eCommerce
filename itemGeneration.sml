(* --- CONFIGURATION --- *)
val ASSOCIATION_STRENGTH = 90; (* Chance that, if chosen to buy swimwear, the user also picks sunscreen *)
...
fun drawItemAttrYoung() = 
    ...
    in
        ...
        then 
            ...
            else if rand3 <= 8 then ("Makeup", discrete(10,50))
            else if rand3 <= 9 then ("Sofa", discrete(300,2000))
...
fun drawItemAttrOld() =
    ...
    in
        ...
        then 
            ...
            else if rand3 <= 10 then ("Makeup", discrete(10,50))
            else if rand3 <= 11 then ("Sofa", discrete(300,2000))
...
fun drawItemAttrSunny() =
    ...
    in
        ...
        then
            ...
            else if rand3 <= 9 then ("Makeup", discrete(10,50))
            else if rand3 <= 10 then ("Sofa", discrete(300,2000))
...
fun drawItemAttrYoungSunny() = 
    ...
    in 
        ...
        then
            ...
            else if rand3 <= 6 then ("Makeup", discrete(10,50))
            else if rand3 <= 7 then ("Sofa", discrete(300,2000))
...
fun drawItemAttrYoungRainy() =
    ...
    in 
        ...
        then
            ...
            else if rand3 <= 7 then ("Makeup", discrete(10,50))
            else if rand3 <= 8 then ("Sofa", discrete(300,2000))
...
fun drawItemAttrNormal() = 
    ...
    in
        ...
        else if rand <= 11 then ("Makeup", discrete(10,50))
        else if rand <= 12 then ("Sofa", discrete(300,2000))
...
fun drawSunscreen() = ("Sunscreen", discrete(2,10))
